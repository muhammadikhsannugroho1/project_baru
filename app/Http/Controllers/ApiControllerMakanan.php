...
class ApiControllerMakanan extends Controller{
    public function ShowMakanan(){
        $response = Http::get('http://localhost:8081/api/userresep/filterkategori?kategori=makanan');
